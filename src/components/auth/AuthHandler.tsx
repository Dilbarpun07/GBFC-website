  ...
  React.useEffect(() => {
    ...
    supabase.auth
      ...
      .catch((error) => {
        ...
        console.log(
          'AuthHandler: setLoadingAuth(false) after getSession error.'
        );
      });
    ...
    const {
      ...
      console.log(
        'AuthHandler: onAuthStateChange event:',
        _event,
        'Session:',
        session
      );
      ...
      setLoadingAuth(false);
      console.log(
        'AuthHandler: setLoadingAuth(false) after onAuthStateChange.'
      );
    ...
    return () => {
      console.log(
        'AuthHandler useEffect cleanup: Unsubscribing from auth state changes.'
      );
